...
/***/ function(module, exports, __webpack_require__) {
	...
	var _VariableText = __webpack_require__(155);
	
	var _VariableText2 = _interopRequireDefault(_VariableText);
	
	var _Nested = __webpack_require__(161);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactAddonsPureRenderMixin = __webpack_require__(156);
	...
	var getText = function getText(num) {
	  return text.slice(0, num).map(function (p, i) {
	    return _react2['default'].createElement(
	      'p',
	      { key: i },
	      p
	...
	var VariableText = _react2['default'].createClass({
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        _2['default'],
	        { onHeightReady: this.onHeightReady, style: styles.content },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var shallowCompare = __webpack_require__(158);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ReactHeight = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _2 = __webpack_require__(159);
	  ...
	  render: function render() {
	    ...
	    return _react2['default'].createElement(
	      ...
	      _react2['default'].createElement(
	        ...
	        null,
	        'Blocks:  ',
	        _react2['default'].createElement('input', { type: 'range', step: 1, min: 1, max: 3,
	      ...
	      _react2['default'].createElement(
	        _3['default'],
	        { dirty: dirty, onHeightReady: this.onHeightReady, style: styles.content },
	        new Array(blocks).join('.').split('.').map(function (_, key) {
	          return _react2['default'].createElement(
	            'div',
	            { key: key, style: { padding: 20 } },
	            _react2['default'].createElement(_VariableText2['default'], null)
	          );
	        })
	      )
